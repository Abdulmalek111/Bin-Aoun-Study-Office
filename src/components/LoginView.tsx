              ...
              {onGoogleLogin && (
                <>
                  ...
                  <button
                    ...
                    className="w-full py-3.5 bg-white hover:bg-gray-50 text-[#0f2544] text-xs font-black rounded-2xl shadow-md transition-all transform active:scale-[0.98] cursor-pointer flex items-center justify-center gap-3.5 disabled:opacity-50 select-none border border-transparent hover:border-gray-100 animate-fade-in"
                    style={{ fontFamily: "'Cairo', sans-serif" }}
                  >
                    {isGoogleLoggingIn ? (
                    ...
                    <span>{isGoogleLoggingIn ? 'جاري الاتصال...' : 'تسجيل الدخول عبر جوجل'}</span>
                  </button>
                </>
              )}
            </div>
              ...
              {onGoogleLogin && (
                <>
                  ...
                  >
                    ...
                    <span>{isGoogleLoggingIn ? 'جاري الاتصال...' : 'سجل الدخول فوراً عبر جوجل'}</span>
                  </button>
                </>
              )}
            </div>
